if(run_pars$trapfit==TRUE){
	...
	dist_summary <- shared_params_df %>% 
		...
		summarise(
			...
			proliferation.time.NonVariant_lwr=quantile(wpmeanW,0.025),
			proliferation.time.NonVariant_upr=quantile(wpmeanW,0.975),
			proliferation.rate.ct.NonVariant_mean=mean(dpmeanW/wpmeanW),
			proliferation.rate.ct.NonVariant_lwr=quantile(dpmeanW/wpmeanW,0.025),
			proliferation.rate.ct.NonVariant_upr=quantile(dpmeanW/wpmeanW,0.975),
			clearance.time.NonVariant_mean=mean(wrmeanW),
			clearance.time.NonVariant_lwr=quantile(wrmeanW,0.025),
			clearance.time.NonVariant_upr=quantile(wrmeanW,0.975),
			clearance.rate.ct.NonVariant_mean=mean(dpmeanW/wrmeanW),
			clearance.rate.ct.NonVariant_lwr=quantile(dpmeanW/wrmeanW,0.025),
			clearance.rate.ct.NonVariant_upr=quantile(dpmeanW/wrmeanW,0.975),
			...
			proliferation.time.Variant_lwr=quantile(wpmeanB,0.025),
			proliferation.time.Variant_upr=quantile(wpmeanB,0.975),
			proliferation.rate.ct.Variant_mean=mean(dpmeanB/wpmeanB),
			proliferation.rate.ct.Variant_lwr=quantile(dpmeanB/wpmeanB,0.025),
			proliferation.rate.ct.Variant_upr=quantile(dpmeanB/wpmeanB,0.975),
			clearance.time.Variant_mean=mean(wrmeanB),
			clearance.time.Variant_lwr=quantile(wrmeanB,0.025),
			clearance.time.Variant_upr=quantile(wrmeanB,0.975),
			clearance.rate.ct.Variant_mean=mean(dpmeanB/wrmeanB),
			clearance.rate.ct.Variant_lwr=quantile(dpmeanB/wrmeanB,0.025),
			clearance.rate.ct.Variant_upr=quantile(dpmeanB/wrmeanB,0.975),
