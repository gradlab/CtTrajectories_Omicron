...
delta_p1_key <- c("<=1 days"="Frequent testing (≤1 days since last non-positive PCR); n=7",
                    ">=2 days"="Testing due to symptoms or contact \n(≥2 days since last non-positive PCR); n=102")
